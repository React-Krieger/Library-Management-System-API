...
const logoutAllSessions = async (req, res) => {
    try {
        ...
        isPasswordCorrect = await bcrypt.compare(req.body.password, req.user.password)
        ...
        if(isEmailCorrect && isPasswordCorrect){
            ...
            await req.user.save()
            return res.status(200).json({msg:"logout Successfully",user:req.user})
        }  
...
module.exports = {userSignup, userLogin, userLogout, logoutAllSessions, userUpdate}